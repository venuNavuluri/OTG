trigger bg_Account_bu on Account (before update)
{
    ...
    if (bypassTrig != null && bypassTrig.ByPass_Account_Triggers__c) {
        System.debug('bg_Account_bu Trigger skipped for user: ');
        return;
    }
    ...
    for (Account acc : Trigger.new)
    {
        ...
        Boolean hierarchyFieldIsNull = acc.Ultimate_Parent_Email__c == null || 
            ...
            acc.Ultimate_Parent_Account_Segmentation__c == null ||
            acc.Ultimate_Parent_Account_Number__c == null ||
            acc.Ultimate_Parent_Account_Sub_AOV__c == null ||
